...
public class BookListingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        arrayList.add(new Book("1","T","100","fjwoj"));
        arrayList.add(new Book("2","T","100","fjwoj"));
        arrayList.add(new Book("3","T","100","fjwoj"));
        arrayList.add(new Book("4","T","100","fjwoj"));
        arrayList.add(new Book("5","T","100","fjwoj"));
        arrayList.add(new Book("6","T","100","fjwoj"));
        arrayList.add(new Book("7","T","100","fjwoj"));
        arrayList.add(new Book("8","T","100","fjwoj"));
        arrayList.add(new Book("9","T","100","fjwoj"));
        arrayList.add(new Book("10","T","100","fjwoj"));
        arrayList.add(new Book("11","T","100","fjwoj"));
